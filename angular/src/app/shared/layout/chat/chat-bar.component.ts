...
export class ChatBarComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    getFixedMessageTime(messageTime: DateTime): string {
        return this._dateTimeService.formatDate(this._dateTimeService.plusSeconds(messageTime, -1 * this.serverClientTimeDifference), 'YYYY-MM-DDTHH:mm:ssZ');
    }
