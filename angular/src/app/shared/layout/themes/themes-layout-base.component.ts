...
export class ThemesLayoutBaseComponent extends AppComponentBase {
    ...
    subscriptionIsExpiringSoon(): boolean {
        if (this.appSession.tenant.subscriptionEndDateUtc) {
            ...
            return daysFromNow >= this._dateTimeService.fromISODateString(this.appSession.tenant.subscriptionEndDateUtc);
        }
    ...
    getSubscriptionExpiringDayCount(): number {
        ...
        let subscriptionEndDateUTC = this._dateTimeService.fromISODateString(this.appSession.tenant.subscriptionEndDateUtc);
        return Math.round(subscriptionEndDateUTC.diff(todayUTC, 'days'));
    }
