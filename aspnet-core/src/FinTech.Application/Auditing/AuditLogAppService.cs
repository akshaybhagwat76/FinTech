...
using FinTech.Auditing.Exporting;
using FinTech.Authorization;
using FinTech.Authorization.Users;
using FinTech.Dto;
using FinTech.EntityHistory;
using EntityHistoryHelper = FinTech.EntityHistory.EntityHistoryHelper;

namespace FinTech.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FinTechAppServiceBase, IAuditLogAppService
    {
