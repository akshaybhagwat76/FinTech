...
using FinTech.Authorization.Users.Profile.Cache;
using FinTech.Authorization.Users.Profile.Dto;
using FinTech.Configuration;
using FinTech.Friendships;
using FinTech.Gdpr;
using FinTech.Net.Sms;
using FinTech.Security;
using FinTech.Storage;
using FinTech.Timing;

namespace FinTech.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : FinTechAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("FinTech",
