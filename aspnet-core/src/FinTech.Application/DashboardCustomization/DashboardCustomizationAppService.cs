...
using FinTech.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace FinTech.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : FinTechAppServiceBase, IDashboardCustomizationAppService
    {
