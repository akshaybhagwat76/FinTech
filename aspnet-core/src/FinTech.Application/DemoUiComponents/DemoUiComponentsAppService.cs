...
using FinTech.DemoUiComponents.Dto;

namespace FinTech.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FinTechAppServiceBase, IDemoUiComponentsAppService
    {
