...
using FinTech.DynamicEntityPropertyValues.Dto;

namespace FinTech.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : FinTechAppServiceBase, IDynamicEntityPropertyValueAppService
    {
