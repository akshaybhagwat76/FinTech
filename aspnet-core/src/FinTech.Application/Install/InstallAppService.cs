...
using FinTech.Migrations.Seed;
using FinTech.Migrations.Seed.Host;
...
namespace FinTech.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FinTechAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FinTechDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{FinTechConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FinTechConsts.ConnectionStringName}", constring);
        }
