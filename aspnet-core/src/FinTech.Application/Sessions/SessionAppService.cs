...
{
    public class SessionAppService : FinTechAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = FinTechConsts.Currency,
                    CurrencySign = FinTechConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = FinTechConsts.AllowTenantsToChangeEmailSettings,
