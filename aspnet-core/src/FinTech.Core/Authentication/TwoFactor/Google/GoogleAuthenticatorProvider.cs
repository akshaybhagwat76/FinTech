...
namespace FinTech.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FinTechServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("FinTech", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
