...
using FinTech.Authorization.Delegation;
using FinTech.Authorization.Ldap;
using FinTech.Authorization.Roles;
using FinTech.Authorization.Users;
using FinTech.Chat;
using FinTech.Configuration;
using FinTech.DashboardCustomization.Definitions;
using FinTech.Debugging;
using FinTech.DynamicEntityProperties;
using FinTech.Features;
using FinTech.Friendships;
using FinTech.Friendships.Cache;
using FinTech.Localization;
using FinTech.MultiTenancy;
using FinTech.Net.Emailing;
using FinTech.Notifications;
using FinTech.WebHooks;

namespace FinTech
{
    [DependsOn(
        typeof(FinTechCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class FinTechCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FinTechLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = FinTechConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FinTechMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<FinTechSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTechCoreModule).GetAssembly());
        }
