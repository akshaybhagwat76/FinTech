...
{
    public class StripeGatewayManager : FinTechServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "FinTech";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + FinTechConsts.Currency;
        }
