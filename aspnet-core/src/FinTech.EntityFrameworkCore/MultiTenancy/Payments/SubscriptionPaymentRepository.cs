...
{
    public class SubscriptionPaymentRepository : FinTechRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<FinTechDbContext> dbContextProvider)
