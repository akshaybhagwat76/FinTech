...
using FinTech.Core.Threading;
using FinTech.Models.NavigationMenu;
using FinTech.Services.Navigation;
...
using FinTech.Controls;
using FinTech.Dto;
using FinTech.Extensions;
using FinTech.Localization;
using FinTech.UI;
using FinTech.UI.Assets;
using FinTech.Views;
using DependencyResolver = FinTech.Core.Dependency.DependencyResolver;
...
namespace FinTech.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "FinTech";
