...
namespace FinTech.Web.Authentication.JwtBearer
{
    public class FinTechJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public FinTechJwtSecurityTokenHandler()
        {
