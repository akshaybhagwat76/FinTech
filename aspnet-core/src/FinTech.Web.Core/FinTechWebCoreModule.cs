...
using FinTech.Web.Authentication.JwtBearer;
using FinTech.Web.Authentication.TwoFactor;
using FinTech.Web.Chat.SignalR;
using FinTech.Web.Configuration;
using FinTech.Web.DashboardCustomization;

namespace FinTech.Web
{
    [DependsOn(
        typeof(FinTechApplicationModule),
        typeof(FinTechEntityFrameworkCoreModule),
    ...
    public class FinTechWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FinTechWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FinTechApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTechWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(FinTechWebCoreModule).Assembly);
        }
