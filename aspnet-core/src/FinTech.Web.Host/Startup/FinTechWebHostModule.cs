...
using FinTech.Web.Startup.ExternalLoginInfoProviders;
...
namespace FinTech.Web.Startup
{
    ...
    public class FinTechWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FinTechWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTechWebHostModule).GetAssembly());
        }
