...
namespace FinTech.Web.Public.Startup
{
    [DependsOn(
        typeof(FinTechWebCoreModule)
    )]
    public class FinTechWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FinTechWebFrontEndModule(IWebHostEnvironment env, FinTechEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTechWebFrontEndModule).GetAssembly());
        }
    }
}
