...
using FinTech.MultiTenancy.HostDashboard;
...
namespace FinTech.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(FinTechDbContext context, SubscriptionPayment subscriptionPayment)
        {
